...
\end{figure}
% rate is g CO2 / min
For the reaction \reactionOne, the average rate in $\defunits$~is represented in the graph by the slope of the dashed lines. This can be verified by calculating the average rate for both tests from the raw data:
\begin{align*}
...
For the reaction \reactionTwo, the average rate in $\defunits$~is also represented in the graph by the slope of the dashed lines. We can calculate the average rate over the first two minutes of our data and the first three minutes of Abigail \& Jersey's data to verify this:
%% show ONE calculation, and then just show the rest of the average rates
\begin{align*}
...
\end{align*}
%% show the rest of the average rates with just the calculated answer
\begin{align*}
