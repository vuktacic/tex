...
The diagrams below illustrate the tip-to-tail addition of the momentum components for the chosen collision (Inelastic 2). In each diagram the blue vector is $\vec p_1$, the red vector is $\vec p_2$ (drawn from the tip of $\vec p_1$), the dotted teal line is the tip-to-tail resultant $\vec p_1+\vec p_2$, and the dashed olive arrow is the system momentum $\vec p_{\mathrm{sys}}$. Component arrows are shown as dashed lines; numeric component values are listed below in equation form using units of \ns.
...
\begin{figure}[H]
    ...
    \end{subfigure}
    \caption{Tip-to-tail addition of momentum components for Inelastic 2; the tip-to-tail resultant (dotted) matches the system momentum (dashed), confirming momentum is conserved.}
